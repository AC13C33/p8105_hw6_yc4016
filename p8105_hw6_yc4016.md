...
fit_logistic = 
  homicide_df %>% 
  glm(homicide_situation ~ victim_age + victim_sex + victim_age, data = .) 
...
```
    ...
    ##         0.6025685          0.0003244         -0.1466972         -0.0511193  
    ## 
    ## Degrees of Freedom: 39402 Total (i.e. Null);  39399 Residual
    ##   (290 observations deleted due to missingness)
    ## Null Deviance:       9845 
    ## Residual Deviance: 9736  AIC: 56740

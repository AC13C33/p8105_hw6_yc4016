...
summary(model_fit)
```
* The model has include variable contains baby's information and basic mother's information (babysex, bhead, bwt, delwt, gaweeks, malform, menarche, mheight, momage, mrace)
